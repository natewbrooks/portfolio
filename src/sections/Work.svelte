...
<section id="work">
  <span class="font-bold text-lg text-green">work <span class="text-xs font-normal text-white/50">({workExperience.length})</span></span>
  <br/>
  <br/>
  <div class="max-h-[600px] md:max-h-[320px] overflow-y-auto">
    <ul class="list-none ml-4 flex-col">
        ...
        <li class={`border-l-2 ${c.border} px-4 py-2`}>
           <div class="w-full flex text-sm">
            ...
            <p>
                ...
                <span class={"text-sm text-white/50"}>{work.description}</span>
            </p>
            
            <!-- <p class="inline text-xs text-white/50">{project.description}</p> -->
