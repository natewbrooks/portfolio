...
declare module "$app/types" {
	export interface AppTypes {
		...
		Asset(): "/NathanielBrooksResume.pdf" | "/images/Nate_Brooks_Resume.pdf" | "/images/bombsniffer.webp" | "/images/caption-creators.webp" | "/images/chess.webp" | "/images/dimf.webp" | "/images/grubguessr.webp" | "/images/joust.webp" | "/images/lexicalanalyzer.webp" | "/images/linganoreumc.webp" | "/images/lizsite.webp" | "/images/management_tool.webp" | "/images/mrfox.GIF" | "/images/portfolioSite.webp" | "/images/ppro.webp" | "/images/rate-my-slippi.webp" | "/images/spark-dating.webp" | "/images/termdleImg.webp" | "/images/tu.webp" | "/images/updatedPortfolio.webp" | "/robots.txt" | string & {};
	}
}