...
declare module "$app/types" {
	export interface AppTypes {
		...
		Asset(): "/images/bombsniffer.webp" | "/images/caption-creators.webp" | "/images/chess.webp" | "/images/dimf.webp" | "/images/grubguessr.webp" | "/images/joust.webp" | "/images/lexicalanalyzer.webp" | "/images/linganoreumc.webp" | "/images/lizsite.webp" | "/images/management_tool.webp" | "/images/mrfox.GIF" | "/images/Nate_Brooks_Resume.pdf" | "/images/optimized/bombsniffer.webp" | "/images/optimized/caption-creators.webp" | "/images/optimized/chess.webp" | "/images/optimized/dimf.webp" | "/images/optimized/grubguessr.webp" | "/images/optimized/joust.webp" | "/images/optimized/lexicalanalyzer.webp" | "/images/optimized/linganoreumc.webp" | "/images/optimized/lizsite.webp" | "/images/optimized/management_tool.webp" | "/images/optimized/portfolioSite.webp" | "/images/optimized/ppro.webp" | "/images/optimized/rate-my-slippi.webp" | "/images/optimized/spark-dating.webp" | "/images/optimized/termdleImg.webp" | "/images/optimized/tu.webp" | "/images/optimized/updatedPortfolio.webp" | "/images/portfolioSite.webp" | "/images/ppro.webp" | "/images/rate-my-slippi.webp" | "/images/spark-dating.webp" | "/images/termdleImg.webp" | "/images/tu.webp" | "/images/updatedPortfolio.webp" | "/NathanielBrooksResume.pdf" | "/robots.txt" | string & {};
	}
}